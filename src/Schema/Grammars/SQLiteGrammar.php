...
class SQLiteGrammar extends Grammar
{
     ...
     *
     * @param  \Intoy\HebatDatabase\Schema\Blueprint  $blueprint
     * @param  \Intoy\HebatSupport\Fluent  $command
     * @return string
     */
     ...
     *
     * @param  \Intoy\HebatSupport\Fluent  $foreign
     * @return string
     */
     ...
     *
     * @param  \Intoy\HebatSupport\Fluent  $column
     * @return string
     */
