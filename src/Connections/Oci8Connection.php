...
use Intoy\HebatDatabase\Query\Grammars\OracleGrammar as SchemaGrammar;
use Intoy\HebatDatabase\Oci8\Schema\OracleBuilder as SchemaBuilder;
use Intoy\HebatDatabase\Oci8\Schema\Sequence;
use Intoy\HebatDatabase\Oci8\Schema\Trigger;
use Intoy\HebatDatabase\Pdo\Oci8\Statement;
...
class Oci8Connection extends Connection
{
     ...
     *
     * @param  \Intoy\HebatDatabase\Pdo\Oci8\Statement  $statement
     * @param  array  $bindings
     * @return void
     */
